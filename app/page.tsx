...
import { Leaf, Search, Upload, ArrowRight, Cloud, Sun, Droplet } from "lucide-react"

export default function SelectPage() {
  const [hoveredOption, setHoveredOption] = useState<"search" | "upload" | null>(null)
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center space-y-4 mb-16">
            ...
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">스마트 농업의 시작</h1>
              <p className="max-w-[600px] mx-auto text-muted-foreground md:text-xl">
                인프라를 검색하거나 직접 업로드하여 스마트 농업을 시작하세요
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <Card
              className={`relative overflow-hidden group cursor-pointer transition-all duration-300 border-2 shadow-lg hover:shadow-xl ${
                hoveredOption === "search" ? "border-green-500" : "border-transparent hover:border-green-300"
              }`}
            ...
            >
              <div className="h-[350px] p-8 flex flex-col items-center justify-center bg-white/80 dark:bg-gray-950/80 backdrop-blur-sm">
                ...
                <p className="text-muted-foreground text-center mb-6 max-w-md">
                  다양한 농업 인프라 컴포넌트를 검색하고 필터링하여 최적의 솔루션을 찾아보세요
                </p>
            ...
            <Card
              className={`relative overflow-hidden group cursor-pointer transition-all duration-300 border-2 shadow-lg hover:shadow-xl ${
                hoveredOption === "upload" ? "border-green-500" : "border-transparent hover:border-green-300"
              }`}
            ...
            >
              <div className="h-[350px] p-8 flex flex-col items-center justify-center bg-white/80 dark:bg-gray-950/80 backdrop-blur-sm">
                ...
                <p className="text-muted-foreground text-center mb-6 max-w-md">
                  자신만의 농업 인프라 컴포넌트를 업로드하고 커뮤니티와 공유하세요
                </p>
                <Button className="bg-green-600 hover:bg-green-700 group-hover:translate-x-1 transition-transform">
                  시작하기
                  <ArrowRight className="ml-2 h-4 w-4" />
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-5xl mx-auto">
            <div className="flex flex-col items-center space-y-2 bg-white/70 dark:bg-gray-950/70 backdrop-blur-sm p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">
                다양한 조건으로 필터링하여 필요한 농업 인프라를 쉽게 찾을 수 있습니다
              </p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-2 bg-white/70 dark:bg-gray-950/70 backdrop-blur-sm p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">
                몇 번의 클릭만으로 자신만의 농업 인프라 컴포넌트를 업로드할 수 있습니다
              </p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-2 bg-white/70 dark:bg-gray-950/70 backdrop-blur-sm p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">최신 기술을 활용한 스마트 농업으로 생산성과 효율성을 높이세요</p>
            </div>
          </div>
        </div>
      </main>
