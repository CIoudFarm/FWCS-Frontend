...
import { Leaf, Send, ArrowRight, Copy, Check, Loader2, Brain, Code, Cpu, Network, Sparkles, Bot } from "lucide-react"
        ...
        <svg className="absolute inset-0 w-full h-full opacity-5" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="network-pattern" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
              <circle cx="50" cy="50" r="1" fill="currentColor" className="text-blue-500" />
            </pattern>
          </defs>
      ...
      <main className="flex-1 w-full py-6 relative z-10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground">AI의 도움을 받아 농업 인프라 컴포넌트 파일을 수정하세요</p>
          </div>
                  ...
                  <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    {messages.map((message) => (
                      ...
                      >
                        ...
                        >
                          <Avatar className={message.role === "user" ? "bg-green-100" : "bg-purple-100"}>
